...
# module references:
# adc500_controller, adc500_decimator
...
proc create_root_design { parentCell } {
  ...
  # Create instance: adc500_decimator_0, and set properties
  set block_name adc500_decimator
  set block_cell_name adc500_decimator_0
  if { [catch {set adc500_decimator_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $adc500_decimator_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#gpio[8]#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#wp#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_net -net LSB_Dout [get_bd_pins LSB/Dout] [get_bd_pins adc500_decimator_0/Din]
  connect_bd_net -net MSB_Dout [get_bd_pins MSB/Dout] [get_bd_pins adc500_decimator_0/TimeIn]
  connect_bd_net -net Net [get_bd_pins adc500_controller_0/SYSCLK] [get_bd_pins adc500_decimator_0/CLK] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins comblock_0/axil_aclk] [get_bd_pins comblock_0/fifo_clk_i] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_250M/slowest_sync_clk]
  ...
  connect_bd_net -net adc500_controller_0_DOUT [get_bd_pins LSB/Din] [get_bd_pins MSB/Din] [get_bd_pins adc500_controller_0/DOUT]
  connect_bd_net -net adc500_controller_0_DVALID [get_bd_pins adc500_controller_0/DVALID] [get_bd_pins adc500_decimator_0/DIvalid]
  ...
  connect_bd_net -net adc500_decimator_0_DOValid [get_bd_pins adc500_decimator_0/DOValid] [get_bd_pins comblock_0/fifo_we_i]
  connect_bd_net -net adc500_decimator_0_Dout [get_bd_pins adc500_decimator_0/Dout] [get_bd_pins comblock_0/fifo_data_i]
  ...
  connect_bd_net -net comblock_0_reg1_o [get_bd_pins adc500_decimator_0/N] [get_bd_pins comblock_0/reg1_o]
  ...
  connect_bd_net -net rst_ps7_0_250M_peripheral_aresetn [get_bd_pins adc500_controller_0/RSTN] [get_bd_pins adc500_decimator_0/resetn] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins comblock_0/axil_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_250M/peripheral_aresetn]
